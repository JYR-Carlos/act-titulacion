...
Uso:
    python calcular_tsr.py                                  # protocolo/planilla_tsr.csv
    python calcular_tsr.py --planilla protocolo/planilla_tsr.csv
    python calcular_tsr.py --planilla planilla.xlsx         # requiere openpyxl

La planilla en blanco está en `protocolo/planilla_tsr_plantilla.csv` y el guion
del escenario en `protocolo/PROTOCOLO_TSR.md`.
...
def main() -> int:
    ...
    ap.add_argument("--planilla",
                    default=str(config.RAIZ / "protocolo" / "planilla_tsr.csv"),
    ...
    if not ruta.exists():
        ...
        print(r"    copy protocolo\planilla_tsr_plantilla.csv protocolo\planilla_tsr.csv")
        print("  El guion del escenario está en protocolo/PROTOCOLO_TSR.md")
        return 1
