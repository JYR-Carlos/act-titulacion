...
`data/catalogos/Glosas_LSCh_Mappeadas.csv` (ver `ESTADO_ACTUAL.md`). Las secuencias de este
...
> Las traducciones al español vienen de `ETIQUETAS_ES` en `scripts/demo_vivo.py`; si esa
...
- [ ] `python scripts/demo_vivo.py --fuente 0` corre y reconoce las 3 señas del guion en
...
- [ ] Al terminar la sesión, guardar también el reporte que deja `scripts/demo_vivo.py`
