...
flujo" (docs/CONTEXTO_PROYECTO.md Sección 10). Reconstruye cada SignSequence a partir
...
Uso:
    python scripts/build_dataset.py                       # lee data/raw/*.csv
    python scripts/build_dataset.py --entrada data/raw/corpus_x.csv --modo ambas
"""
...
def main() -> int:
    ...
    if not csvs:
        print(f"No hay CSV de entrada en {config.DATA_RAW_DIR}.\n"
              ...
              "    python scripts/extraer_lote.py --videos-dir <dir> "
              "--anotaciones data/catalogos/lsa64_10_annotations.csv "
              "--salida data/raw/lsa64_10.csv\n"
              "  o graba corpus propio con:  python scripts/grabar_corpus.py --senante s01")
        return 1
