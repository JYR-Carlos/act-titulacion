...
Uso:
    python scripts/entrenar.py                                  # data/processed/dataset.npz
    python scripts/entrenar.py --dataset data/processed/dataset.npz
    python scripts/entrenar.py --sintetico                      # dataset falso (smoke test)
    python scripts/entrenar.py --cv                             # + validación cruzada k-fold
    python scripts/entrenar.py --cv --cv-folds 5 --solo-cv      # solo evaluar, sin exportar
"""
...
def main() -> int:
    ...
    print("Siguiente paso:  python scripts/exportar_onnx.py")
    return 0
