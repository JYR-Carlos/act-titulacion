...
Ejemplos:
  python scripts/extraer_keypoints.py --modo webcam --fuente 0
  python scripts/extraer_keypoints.py --modo webcam --fuente http://192.168.1.42:8080/video
  python scripts/extraer_keypoints.py --modo video --fuente sena.mp4 --label HOLA --salida data/raw/hola.csv
"""
