...
vídeos y se re-extrae con nuestra Capa 1 (coherente con docs/DECISION_PREPROCESAMIENTO.md).
...
def main() -> int:
    ...
    print("Siguiente:  python scripts/build_dataset.py --entrada", args.salida)
    return 0
