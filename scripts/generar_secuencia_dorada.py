...
Uso:
    python scripts/generar_secuencia_dorada.py                  # genera JSON + CSV
    python scripts/generar_secuencia_dorada.py --verificar      # comprueba que sigue vigente
    python scripts/generar_secuencia_dorada.py --video data/external/lsa64/videos/039_010_002.mp4

Ver docs/INTEGRACION_UNITY.md, sección 7 ("running_mode oficial").
"""
...
# --------------------------------------------------------------------------- #
# running_mode OFICIAL del proyecto — ver docs/INTEGRACION_UNITY.md sección 7.
#
...
def construir_documento(video: Path, n: int, modo: str,
    ...
    doc = {
        ...
        "proposito": ("Vectores dorados de una SECUENCIA real en movimiento, "
                      ...
                      "Unity frame a frame. Ver docs/INTEGRACION_UNITY.md sec. 7."),
...
def main() -> int:
    ...
    print(f"\nUnity debe reproducir estos frames con running_mode="
          f"'{doc['running_mode']}'. Ver docs/INTEGRACION_UNITY.md sección 7.")
    return 0
